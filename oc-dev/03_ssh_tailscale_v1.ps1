# 03_ssh_tailscale_v1.ps1 - SSH and Tailscale with credential placeholder
param([string]$DistroName = "oc-dev")
$ErrorActionPreference = "Stop"

# Check for required env var (loaded by wrapper from secrets.ps1)
...
# Start and register using environment variable
